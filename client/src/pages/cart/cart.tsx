...
export default function Cart() {
    ...
    return (
      <div className="cart">
        <div className="cart-empty">
          <h1>{language === "sv" ? "Din korg" : "Your cart"}</h1>

          <p>{language === "sv" ? "Din korg är tom" : "Your cart is empty"}</p>
  ...
  const applyDiscount = async () => {
    if (!discountCode.trim()) {
      setDiscountError(
        language === "sv" ? "Ange en rabattkod." : "Enter a discount code.",
      );
      return;
    }
      ...
      <div className="cart-layout">
              ...
              >
                ...
                <div className="cart-item-info">
                  ...
                  {item.selected_print_color && (
                    <p className="cart-item-text">
                      {language === "sv" ? "Tryckfärg" : "Print colour"}:{" "}
        ...
        <div className="cart-summary">
          ...
          <div className="cart-summary-rows">
            ...
            <div className="cart-discount">
              <label htmlFor="discount-code">
                {language === "sv" ? "Rabattkod" : "Discount code"}
              </label>
              ...
              <div className="cart-discount-input">
                <input
                  ...
                  placeholder={
                    language === "sv" ? "Ange rabattkod" : "Enter discount code"
                  }
              ...
              {discountError && (
                <p className="cart-discount-error">{discountError}</p>
              )}
            ...
            <div className="cart-summary-row">
              <span>{language === "sv" ? "Moms (25 %)" : "VAT (25%)"}</span>
          ...
          <NavLink to="/payment" className="cart-checkout-btn">
            {language === "sv" ? "Gå till betalning" : "Proceed to checkout"}
          </NavLink>
        </div>
      </div>
    </div>
